...
public class UTXO implements Comparable<UTXO> {
    ...
    /**
     * Creates a new UTXO corresponding to the output with index <index> in the
     * transaction whose hash is {@code txHash}
     */
    ...
    /**
     * Compares this UTXO to the one specified by {@code other}, considering
     * them equal if they have {@code txHash} arrays with equal contents and
